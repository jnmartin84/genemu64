...
void MemoryStream_Create(MemoryStream *memory_stream, unsigned long gen_buf, cc_bool_fast free_buffer_when_destroyed);
...
unsigned char MemoryStream_GetBuffer(MemoryStream *memory_stream, size_t pos);
